...
public class HS384Test {
    ...
    public void validateTokenTest() throws UnsupportedEncodingException {
        ...
        JWTParser jwtParser = JWTParser.newInstance(Algorithm.HMACSHA384, "secret".getBytes(charsetName), charsetName);
        ...
        assertThat(jwt.getHeader().get("alg"), is(Algorithm.HMACSHA384.getName()));
